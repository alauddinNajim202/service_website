                ...
                <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="max-width: 600px; background-color: #161616; border-radius: 8px; border: 1px solid #2A2A2A; overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 0 40px 40px 40px;">
                            <h2 style="color: #FFFFFF; font-size: 24px; font-weight: 600; margin: 0 0 20px 0; text-align: center;">Reset Your Password</h2>
                            
                            <p style="color: #E0E0E0; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">Hi {{ $user->name }},</p>
                            
                            <p style="color: #E0E0E0; font-size: 16px; line-height: 1.6; margin: 0 0 30px 0;">We received a request to reset your password for your VUQIA account. You can securely reset your password by clicking the button below.</p>
                            
                            <div style="text-align: center; margin-bottom: 30px;">
                                <a href="{{ $verificationUrl }}" style="background-color: #CFA267; color: #121212; padding: 14px 32px; border-radius: 6px; text-decoration: none; font-size: 16px; font-weight: 600; display: inline-block;">Reset Password</a>
                            </div>
                            
                            <p style="color: #A0A0A0; font-size: 14px; line-height: 1.6; margin: 0 0 10px 0;">If you didn't request a password reset, you can safely ignore this email. Your password will remain unchanged.</p>
