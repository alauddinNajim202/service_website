                                ...
                                <table class="table table-bordered text-nowrap border-bottom" id="datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="bg-transparent border-bottom-0 wp-15">Name (EN)</th>
                                            <th class="bg-transparent border-bottom-0 wp-15">Name (FR)</th>
                                            <th class="bg-transparent border-bottom-0 wp-15">Name (SP)</th>
