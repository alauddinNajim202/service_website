...
class HomeSafeSpaceController extends Controller
{
    ...
    public function __construct(CmsService $cmsService)
    {
        ...
        $this->section = SectionEnum::SAFE_SPACE;
    }
    /**
    ...
    public function index()
    {
        ...
        return view("backend.layouts.cms.safe_space_index", ["data" => $data, "page" => $this->page->value, "section" => $this->section->value, "component" => $this->component, 'sections' => $this->sections]);
    }
    ...
    public function content(CmsRequest $request)
    {
        ...
        try {
            ...
            if (isset($validatedData['title_en'])) {
                $validatedData['title'] = $validatedData['title_en'];
            }
            if (isset($validatedData['description_en'])) {
