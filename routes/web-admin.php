...
use App\Http\Controllers\Web\Backend\CMS\Web\Home\HomeSafeSpaceController;
...
use App\Http\Controllers\Web\Backend\SessionPackageController;
...
Route::group(['middleware' => ['web-admin']], function () {
    ...
    Route::controller(SessionPackageController::class)->prefix('session-packages')->name('session-packages.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::get('/show/{id}', 'show')->name('show');
        Route::get('/edit/{id}', 'edit')->name('edit');
        Route::post('/update/{id}', 'update')->name('update');
    ...
    */
    ...
    Route::prefix('cms')->name('cms.')->group(function () {
        ...
        //Home Safe Space
        Route::prefix('home/safe_space')->name('home.safe_space.')->controller(HomeSafeSpaceController::class)->group(function () {
            Route::get('/', 'index')->name('index');
            Route::get('/{id}/show', 'show')->name('show');
    ...
    **/
    ...
    // Legal Documents
    Route::controller(App\Http\Controllers\Web\Backend\LegalDocumentController::class)->prefix('legal')->name('legal.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::patch('/update', 'update')->name('update');
    });

    // Social Profiles
    Route::controller(App\Http\Controllers\Web\Backend\SocialProfileController::class)->prefix('social-profile')->name('social-profile.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::patch('/update', 'update')->name('update');
    });

    // Top Creators
    Route::controller(App\Http\Controllers\Web\Backend\TopCreatorController::class)->prefix('top-creator')->name('top-creator.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::get('/create', 'create')->name('create');
        Route::post('/store', 'store')->name('store');
        Route::get('/status/{id}', 'status')->name('status');
    ...
    // Creators Management
    Route::controller(App\Http\Controllers\Web\Backend\CreatorController::class)->prefix('creators')->name('creators.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::delete('/destroy/{id}', 'destroy')->name('destroy');
    });
});
