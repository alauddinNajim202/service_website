    ...
    public function run(): void
    {
        if (app()->environment('local')) {
            ...
            DB::table('roles')->insert([
                ['id' => 1, 'name' => 'admin', 'slug' => 'admin', 'guard_name' => 'web'],
                ['id' => 2, 'name' => 'creator', 'slug' => 'creator', 'guard_name' => 'api'],
                ['id' => 3, 'name' => 'user', 'slug' => 'user', 'guard_name' => 'api'],
            ]);

            DB::table('users')->insert([
                ['id' => 1, 'name' => 'Admin', 'slug' => 'admin', 'email' => 'admin@admin.com', 'password' => Hash::make('12345678'), 'stripe_account_id' => 'acct_1RHGjbQPESrwz7hv', 'otp_verified_at' => now(), 'is_owner' => '1'],
                ['id' => 2, 'name' => 'Creator', 'slug' => 'creator', 'email' => 'creator@creator.com', 'password' => Hash::make('12345678'), 'stripe_account_id' => 'acct_1RHGjbQPESrwz7hv', 'otp_verified_at' => now(), 'is_owner' => '0'],
